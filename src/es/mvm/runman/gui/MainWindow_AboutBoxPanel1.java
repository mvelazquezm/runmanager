...
public class MainWindow_AboutBoxPanel1 extends JPanel {
    ...
    public MainWindow_AboutBoxPanel1() {
        try {
            jbInit();
    ...
    private void jbInit() throws Exception {
        ...
        labelTitle.setText( "RunManager Versión 1.0" );
        labelAuthor.setText( "Author: mvm" );
        labelCopyright.setText( "Copyright: GPL" );
        labelCompany.setText( "Company: mvm" );
